...
<p>
	 2.4.2. Компания ООО фирма «ЭксСер» продолжает хранить персональные данные для подтверждения фактов подписки и отписки от рассылки и не использует их в иных целях. 
</p>
<p>
