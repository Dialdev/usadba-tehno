...
echo '<input type="hidden" name="MNT_DESCRIPTION" value="' . GetMessage("PAYMENT_PAYANYWAY_ORDER") . ' #' . $MNT_TRANSACTION_ID . '">';
...
echo '<input type="submit" value="' . GetMessage("PAYMENT_PAYANYWAY_BUTTON") . '">';
echo '</p>';
echo '</font>';
echo '</form>';
