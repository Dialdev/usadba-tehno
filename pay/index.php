...
$APPLICATION->SetPageProperty("keywords", "Публичная оферта");
$APPLICATION->SetPageProperty("description", "Публичная оферта  | Усадьба Техно");
$APPLICATION->SetTitle("Публичная оферта");
?><h2>Публичная оферта</h2>
<p>Интернет-магазин «Усадьба-Техно», расположенный на доменном имени www.usatba-texno.ru, принадлежащий обществу с ограниченной ответственностью «Дионис-II», находящемуся по адресу: г. Тула, ул. Демидовская плотина, д.13, в лице Генерального директора Тишковой Любови Григорьевны, действующей на основании Устава, именуемое в дальнейшем «Продавец», публикует Публичную оферту о продаже Товара дистанционным способом.</p>
...
1.2.	Заказ Товара на сайте Интернет-магазина – позиции указанные Покупателем из ассортимента Товара, предложенного к продаже, при оформлении заявки на приобретение Товара на сайте Интернет-магазина или через Оператора.</p>

<h2>2.	ОБЩИЕ ПОЛОЖЕНИЯ</h2>
<p>2.1. Заказ Покупателем Товара, размещенного на сайте Интернет-магазина означает, что Покупатель согласен со всеми условиями настоящей Оферты.<br>
...
2.4. Продавец предоставляет Покупателю полную и достоверную информацию о Товаре, включая информацию об основных потребительских свойствах Товара, месте изготовления, а также информацию о гарантийном сроке и сроке годности Товара на сайте Интернет магазина.</p>
...
3.3. В случае изменения цены на заказанный Товар Продавец обязуется в течение 3(трёх) рабочих дней проинформировать Покупателя об изменении цены Товара.<br>
...
3.7. Обязательства Покупателя по оплате Товара считаются исполненными с момента получения Продавцом денежных средств.<br>
3.8. Расчеты между Продавцом и Покупателем за Товар производятся способами, указанными на сайте Интернет-магазина в разделе  название раздела</p>

<h2>4. ОФОРМЛЕНИЕ ЗАКАЗА</h2>
<p>4.1. Заказ Товара осуществляется Покупателем через Оператора по телефону +7(4872)42-58-12 или через сервис сайта Интернет-магазина www. karnizoptom.ru.<br>
...
4.9. Договор купли-продажи дистанционным способом между Продавцом и Покупателем считается заключенным с момента получения Продавцом сообщения о намерении Покупателя приобрести Товар.</p>

<h2>5.	ДОСТАВКА И ПЕРЕДАЧА ТОВАРА ПОКУПАТЕЛЮ</h2>
<p>5.1. Продавец оказывает Покупателю услуги по доставке Товара одним из способов указанных на сайте Интернет-магазина.<br>
5.2. Если Договор купли-продажи товара дистанционным способом (далее – Договор) заключен с условием о доставке Товара Покупателю, Продавец обязан в установленный Договором срок доставить Товар в место, указанное Покупателем.<br>
...
<p>Юр. адр: 300001,  г. Тула, ул. Демидовская плотина, 13<br>
Факт. адр.: 300001,  г. Тула, ул. Демидовская плотина, 13<br>
тел./факс  +7(4872) 42-58-12<br>
Р/с 40702810700960000042<br>
ОАО «УРАЛСИБ» г. Москва<br>

БИК 044525787<br>
Кор./сч. 30101810100000000787<br>
ИНН  7104526513<br>
ОГРН    1147154040065<br>
E-mail     usatba-texno@mail.ru</p>
