...
foreach ($arResult['ITEMS'] as $key => $arItem) {
	if ($arItem['PROPERTY_TYPE'] == 'L' || $arItem['PROPERTY_TYPE'] == 'S' || $arItem['PROPERTY_TYPE'] == 'E' ){
		if ($arItem['VALUES']) {
			$show_filter = true;
		}
	}
...
if ($arResult['ITEMS']['base']['VALUES']['MAX']['VALUE'] == $arResult['ITEMS']['base']['VALUES']['MIN']['VALUE']) {
	$show_filter = false;
} else {
	$show_filter = true;
}
...
?>
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								case "U"://CALENDAR
									?>
									<div class="row bx-filter-parameters-box-container-block"><div class="bx-filter-input-container bx-filter-calendar-container">
