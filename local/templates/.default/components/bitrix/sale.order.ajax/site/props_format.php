	...
	function PrintPropsForm($arSource = array(), $locationTemplate = ".default")
	{
		if (!empty($arSource))
		{
			...
			<div>
				...
				{
					?>
					<div class="order-item__<?=$arProperties["ID"]?>" data-property-id-row="<?=intval(intval($arProperties["ID"]))?>">
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							...
							<div class="bx_block r3x1">
								<input class="form__text" type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" />
								<?if (strlen(trim($arProperties["DESCRIPTION"])) > 0):?>
									<div class="bx_description"><?=$arProperties["DESCRIPTION"]?></div>
								<?endif?>
							</div>
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
							...
							?>
							<div class="bx_block r3x1">
								<textarea class="form__textarea" rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"><?=$arProperties["VALUE"]?></textarea>
								<?if (strlen(trim($arProperties["DESCRIPTION"])) > 0):?>
									<div class="bx_description"><?=$arProperties["DESCRIPTION"]?></div>
								<?endif?>
							</div>
