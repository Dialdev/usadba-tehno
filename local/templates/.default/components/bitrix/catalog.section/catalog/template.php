...
<div class="catalog-section">
    ...
    <!---->
    <? /*echo "<pre>"; print_r($arItem["CATALOG_QUANTITY"]); echo "</pre>";*/?>
    <!---->
</div>

<div class="image">
    <?if ($arItem["DETAIL_PICTURE"]["SRC"]!=""):?>
    <img alt="<?=$arItem["NAME"]?>" src="<?=$arItem['RESIZED_IMAGE']['src']?>">
    <?else:?>
    <img alt="<?=$arItem["NAME"]?>" src="/local/templates/index/images/no_photo.png">
    <?endif;?>
</div>
...
<?
$ipropValues = new Bitrix\Iblock\InheritedProperty\SectionValues($arResult["IBLOCK_ID"], $arParams["MY_SECTION_ID"]);
$arResult["IPROPERTY_VALUES"] = $ipropValues->getValues();
$APPLICATION->setPageProperty('h1-title',$arResult["IPROPERTY_VALUES"]['SECTION_PAGE_TITLE']);
$section = CIBlockSection::GetById($arParams["MY_SECTION_ID"])->getNext();
