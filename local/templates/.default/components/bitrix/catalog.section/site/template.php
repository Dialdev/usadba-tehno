			...
			<a href="<?=$arItem["DETAIL_PAGE_URL"]?>">
				...
				<div class="image">
					<?if ($arItem["DETAIL_PICTURE"]["SRC"]!="") {?>
						    	<? 
      	$renderImage = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"], Array("width" => 286, "height" => 220), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, false); 
      	echo '<img title="'.$arItem["NAME"].'" alt="'.$arItem["NAME"].'" src="'.$renderImage["src"].'" />'; 
?>
