...
?> class="reviews-form">
	...
	<div style="position:relative; display: block; width:100%;">
		...
		if (!$arResult["IS_AUTHORIZED"]):
			...
			<div class="reviews-reply-fields">
				<div class="reviews-reply-field-user">
					<div class="reviews-reply-field reviews-reply-field-author"><label class="form-authtor-name" for="REVIEW_AUTHOR<?=$arParams["form_index"]?>"><?=GetMessage("OPINIONS_NAME")?><?
							?><span class="reviews-required-field">*</span></label>
						<span class="form-author-input"><input name="REVIEW_AUTHOR" required="required"  id="REVIEW_AUTHOR<?=$arParams["form_index"]?>" size="30" type="text" value="<?=$arResult["REVIEW_AUTHOR"]?>" tabindex="<?=$tabIndex++;?>" /></span></div>
					<?
		...
		?>
		<div class="reviews-reply-header"><span>Комментарий</span><span class="reviews-required-field">*</span></div>
		...
		<div class="reviews-reply-buttons">
			<input class="form__submit" name="send_button" type="submit" value="<?=GetMessage("OPINIONS_SEND")?>" tabindex="<?=$tabIndex++;?>" <?
