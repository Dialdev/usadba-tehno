...
<!-- ************ покупка в кредит кнопка ******** -->

				<a href="/kredit.php?cena=<?=$arResult["PRICES"]["base"]["DISCOUNT_VALUE"]?>&tovar=<? echo urlencode($arResult["NAME"]); ?>&price=<?=$arResult["PRICES"]["base"]["DISCOUNT_VALUE"]?>" target="_blank" id="pos-credit-link">Покупки в кредит</a>
